...
export default function SingleProductData({ product }: SingleProductCardProps) {
  return (
    <div className='h-[80vh] max-w-screen-xl flex flex-col justify-center mx-auto '>
      <div className='flex bg-neutral-50 '>
        {/* product image */}
        <div className='flex-1 h-full '>
          <div className=' bg-white w-[32rem] '>
            <Image
              width={400}
              height={400}
              src={product.imageUrl}
              alt={product.name}
              className=' h-[32rem] object-contain w-full'
            />
          </div>
        </div>
        {/* product info */}
        <div className='flex-1 h-full '>
          <div className='flex flex-col space-y-4 p-4 w-[32rem]  '>
